...
write.table(observed, "cleaned_results/observed.csv", sep = ",")
# Simulated heterozygosity and pairwise stats
write.csv(stats, "cleaned_results/stats.csv")
# Parameters for each simulation and replicate
write.csv(rep_info, "cleaned_results/rep_info.csv")
# Sampling locations
write.csv(sample_locs, "cleaned_results/sample_locs.csv")
# Stats for all simulations
write.csv(all_stats, "cleaned_results/all_stats.csv")
# Pairwise stats for all simulations
write.csv(all_pairstats, "cleaned_results/all_pairstats.csv")

write.csv(observed_stats, "cleaned_results/observed_stats.csv")
write.csv(observed_pairstats, "cleaned_results/observed_pairstats.csv")
